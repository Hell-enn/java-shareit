...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> postItemRequest(Long userId, ItemRequestInDto itemRequestInDto) {
        return post("", userId, itemRequestInDto);
    }


    public ResponseEntity<Object> patchItemRequest(Long userId, ItemRequestInDto itemRequestInDto, Long requestId) {
